...
Explore the [attraction-led visual gallery](docs/attraction-gallery.md) and [full historical stop sequence](docs/stops-and-images.md). The gallery links sight photographs and names their creators, licences and visit limits. Christiana’s photographer-identified Vaal River image needs permission before publication inside the guide.
